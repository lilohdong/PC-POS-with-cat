...
public class PopularGameRankingPanel extends JPanel {
    ...
    private void initUI() {
        ...
        titleLabel.setFont(new ClearGodic(16));
        titleHeaderPanel.add(titleLabel);
        // 백그라운드 연분홍
        titleHeaderPanel.setBackground( new Color(234, 191, 255) );
        // font color는 블랙
        titleLabel.setForeground(Color.BLACK);
        headerPanel.add(titleHeaderPanel, BorderLayout.NORTH);
        ...
        shareLabel.setFont(new ClearGodic(12));
